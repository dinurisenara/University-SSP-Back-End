...
const{getClasses,changeFixedSchedule,getExtraSchedules,addExtraSchedule, deleteExtraSchedule,updateExtraSchedule, getClassScheduleDetails, getClassDetails} = require('./../controllers/academicStaff/classController');
...
router.get('/classes/details',verifyRole(ROLES_LIST.Academic_Staff),getClassDetails);
